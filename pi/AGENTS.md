...
- **Lean RPIV workflow (repo-local rules)**:
  ...
  - **Markdown preview**: `npm:pi-markdown-preview` is installed/enabled by `./scripts/setup.sh` as a global Pi package. It is not hat-specific and should work in normal sessions alongside search skills such as Brave/Firecrawl.
